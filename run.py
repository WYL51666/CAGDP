...
def setup_logger(dataname):
    ...
    file_handler = logging.FileHandler(f'Log/{dataname}/{now_str}.log')
...
def main(data_path, seed=2024):
    ...
    # ========= Building Model =========# 
    model = trans_to_cuda(Module(hypergraphs=[HG_G, HG_L], args = opt,text_embedding=text_embedding,dropout=opt.dropout))
    # ========= Early_stopping =========#
    save_model_path = opt.save_path + data_path+'_CAGDP.pt'
